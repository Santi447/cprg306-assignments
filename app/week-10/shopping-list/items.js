...
export default function Item({name,quantity,category,imageUrl, onSelect}){
  return(
  <li className="flex flex-col items-center bg-card p-6 border border-default rounded-xl shadow-xs md:flex-row md:max-w-xl hover:bg-gray-800" onClick={onSelect}>
